...
vdem2 %>% select(country_name,year,country_id,v2x_polyarchy,v2x_libdem,v2x_delibdem,v2x_egaldem,
...
data <- merge(vdem2,partydat,by=c("country_name","year"),all.x=TRUE)
...
ccpc <- read.csv("ccpcnc/ccpcnc_v3_small.csv")
